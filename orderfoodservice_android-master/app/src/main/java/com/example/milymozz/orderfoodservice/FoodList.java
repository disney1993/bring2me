...
import com.example.milymozz.orderfoodservice.Model.Food;
import com.example.milymozz.orderfoodservice.ViewHolder.FoodViewHolder;
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Log.d("FOO", newFood.getName() + newFood.getDescription() + newFood.getPrice() + newFood.getDiscount() + newFood.getMenuId());
